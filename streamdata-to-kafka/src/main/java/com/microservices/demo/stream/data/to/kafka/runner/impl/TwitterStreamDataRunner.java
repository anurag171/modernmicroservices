...
public class TwitterStreamDataRunner implements StreamRunner {
  ...
  private final StreamDataToKafkaConfig streamDataToKafkaConfigData;
  ...
  private void addFilter() {
    String[] keywords = streamDataToKafkaConfigData.getTwitterKeywords().toArray(new String[]{});
    FilterQuery filterQuery = new FilterQuery(keywords);
    twitterStream.filter(filterQuery);
    log.info("Started filtering stream for keywords {}",streamDataToKafkaConfigData.getTwitterKeywords());
  }
